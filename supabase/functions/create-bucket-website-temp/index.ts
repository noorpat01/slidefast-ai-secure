...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["text/html", "text/css", "application/javascript", "application/json", "image/*", "text/plain"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for website" ON storage.objects FOR SELECT USING (bucket_id = 'website');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for website" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'website');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for website" ON storage.objects FOR UPDATE USING (bucket_id = 'website');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for website" ON storage.objects FOR DELETE USING (bucket_id = 'website');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'website',
        public: true,
        allowed_mime_types: ["text/html", "text/css", "application/javascript", "application/json", "image/*", "text/plain"],
