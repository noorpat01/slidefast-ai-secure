...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "application/pdf", "application/vnd.openxmlformats-officedocument.presentationml.presentation"];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'presentations',
        public: true,
        allowed_mime_types: ["image/*", "application/pdf", "application/vnd.openxmlformats-officedocument.presentationml.presentation"],
